...
import card3 from '@/assets/cards/card=3.gif';
...
import card11 from '@/assets/cards/card=11.gif';
import card12 from '@/assets/cards/card=12.png';
import card13 from '@/assets/cards/card=13.png';
import card14 from '@/assets/cards/card=14.gif';
...
import card18 from '@/assets/cards/card=18.gif';
import card19 from '@/assets/cards/card=19.png';
import card20 from '@/assets/cards/card=20.png';
import card21 from '@/assets/cards/card=21.gif';
